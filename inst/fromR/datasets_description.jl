...
#'    \item{Tair_qc}{Quality control of `Tair` [TA_F_QC]}
#'    \item{PPFD}{Photosynthetic photon flux density (umol m-2 s-1) [PPFD_IN]}
#'    \item{PPFD_qc}{Quality control of `PPFD` [PPFD_IN_QC]}
#'    \item{VPD}{Vapor pressure deficit (kPa) [VPD_F]}
#'    \item{VPD_qc}{Quality control of `VPD` [VPD_F_QC]}
#'    \item{pressure}{Atmospheric pressure (kPa) [PA_F]}
#'    \item{precip}{precipitation (mm) [P_F]}
#'    \item{precip_qc}{Quality control of `precip` [P_F_QC]}
...
#'    \item{Ca_qc}{Quality control of `Ca` [CO2_F_MDS_QC]}
...
#'    \item{LE_qc}{Quality control of `LE` [LE_F_MDS_QC]}
#'    \item{H}{Sensible heat flux (W m-2) [H_F_MDS]}
#'    \item{H_qc}{Quality control of `H` [H_F_MDS_QC]}
#'    \item{G}{Ground heat flux (W m-2) [G_F_MDS]}
#'    \item{G_qc}{Quality control of `G` [G_F_MDS_QC]}
#'    \item{NEE}{Net ecosystem exchange (umol m-2 s-1) [NEE_VUT_USTAR50]}
#'    \item{NEE_qc}{Quality control of `NEE` [NEE_VUT_USTAR50_QC]}
