...
abstract type SymbolValueCall end

struct BigleafConstants <: SymbolValueCall end

(cst::BigleafConstants)(::Val{sym}) where sym = getproperty(BigleafConstantsDef, sym)
